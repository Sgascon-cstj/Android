...
abstract class AppDatabase: RoomDatabase() {
    //Changer la ligne ici: dans le tp sa risque d'être DeliveryRepository
    ...
    companion object {
        ...
        private fun buildDatabase(context: Context) =
            Room.databaseBuilder(context.applicationContext, AppDatabase::class.java, "notes")//notes = nom du fichier sql en mémoire dans le téléphone
